...
//=============================================================================
 * @endcode
 * В примере aldoniSercxantaPointo, reveniAlMomentoPointo, finisxiIteracio вызываются на пямую. Но все они являются слотами и могут быть соединены с сигналами.
